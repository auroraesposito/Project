...
public class DoniCtrl {
	...
	public void aggiungiDonoAlSacco() { //overload del metodo aggiungiDonoAlSacco
	...
	public double getPesoSacco() {
		...
		for (int i = 0; i < sacco.getDoni().length; i++) {
			if (sacco.getDoni() [i] !=null)
			 peso += sacco.getDoni()[i].getPeso(); //rischio nullpointerexception. aggiungendo riga 45 annullo il rischio
		}
		return peso; 
